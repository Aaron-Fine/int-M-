...
[automation baseline](../../evidence/phase-1/automation-2026-08-12.md) records
...
| `MI-UX-003` Progressive first frame        | **Partial** | `presents coarse and stable frames in order for one render request`; `CpuRenderer` progressive unit evidence                                                               | Target-device coarse/stable presentation budgets                                                                    |
...
| `MI-UX-007` Responsive navigation          | **Partial** | Area/keyboard navigation; presentation/cancellation marks; viewport and cancellation unit tests                                                                            | Manual release-browser pointer-pan/Escape-cancel evidence, target response, cancellation p95, and long-task budgets |
...
| `MI-UX-011` Non-color state distinction    | **Partial** | Semantic color/texture tests, persistent crosshair/ring marker, shape-coded catalog markers, and forced-colors browser checks                                              | Manual simulated color-vision and canvas review                                                                     |
...
| `MI-UX-016` Accessible interface           | **Partial** | Axe WCAG A/AA; forced-colors focus/state cues; 320/375/430 px reflow; 320 px evidence/error/retry; overflow, canvas-ratio, and 44 px target checks in Firefox and Chromium | Manual assistive-technology, 200% text zoom, native high contrast, and color-vision review                          |
