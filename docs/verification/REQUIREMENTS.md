...
| `MI-UX-007` Responsive navigation          | **Partial** | Immediate pan implementation, automated area/keyboard navigation, presentation marks, viewport math, cancellation tests                                         | Manual release-browser pointer-pan/cancel evidence, target-device response, cancellation p95, and long-task budgets |
...
| `MI-UX-016` Accessible interface           | **Partial** | Axe WCAG A/AA scans in primary and inspector states plus 320/375/430 px reflow, overflow, canvas-ratio, and 44 px control-target checks in Firefox and Chromium | Manual WCAG 2.2 AA review, canvas alternative, 200% text zoom, and color-vision checks                              |
